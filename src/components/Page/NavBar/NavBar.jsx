...
const NavBar = () => {
    ...
    <li><Link to='/pages' className=" font-bold">PAGES</Link></li>
    <li><Link to='/blog' className=" font-bold">BLOG</Link></li>
    <li><Link to='/byTheme' className=" font-bold">BY THEME!</Link></li>
    </>
  ...
  <div className="flex-1 justify-center">
    ...
    <a className="btn btn-ghost text-xl"> ALUKAS  & CO</a>
  </div>
...
<div className="navbar  bg-white">
  <div className="navbar-start">
    ...
    <a className="btn btn-ghost text-xl">Browse Categories</a>
  </div>
